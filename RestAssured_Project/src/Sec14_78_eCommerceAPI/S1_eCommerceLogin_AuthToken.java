...
public class S1_eCommerceLogin_AuthToken {
	...
	public static void main(String[] args) {
		...
		RequestSpecification delOrderReq = given().spec(deleteProductBaseReq).pathParam("productID", productID);
		String delProductResponse = delOrderReq.when().delete("/api/ecom/product/delete-product/{productID}")
